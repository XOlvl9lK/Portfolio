        ...
        return (
            <div className="about">
                <div className="about-wrap wrap">
                    ...
                    <div className="photo">
                        <Member imgURL={"img/zhma-she.png"} name={"Жмышенко Валерия Альбертовна"} description={["Веб-дизайнер"]}/>
                        <Member imgURL={"img/zhma-he.png"} name={"Жмышенко Валерий Альбертович"} description={["Веб-дизайнер", "Веб-дизайнер", "Веб-дизайнер"]}/>
                    </div>
